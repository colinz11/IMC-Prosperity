from algo_trading_day_3 import Trader
...
def simulate_alternative(round: int, day: int, trader, print_position=False, time_limit=999900, end_liquidation=True):
    prices_path = f"prices_round_{round}_day_{day}.csv"
    trades_path = f"trades_round_{round}_day_{day}_nn.csv"
...
if __name__ == "__main__":
    trader = Trader()
    simulate_alternative(3, 2, trader, False, 1000000)