...
class Trader:
    ...
    acceptable_buy_price = 4880
    acceptable_sell_price = 4910
    previous_position = 0
    ...
    def update(self, position, avg_price):
        if position == 0:
            ...
            self.acceptable_buy_price = min(self.acceptable_buy_price-0.5, avg_price)
            self.acceptable_sell_price = max(self.acceptable_sell_price+0.5, avg_price)
            return
